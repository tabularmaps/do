...
振興局の継ぎ目や構造余白の位置は設計判断であり、目的関数の副産物にしない。
  ...
  入力 2. data/municipalities.json         — 北海道の市町村マスター (179市町村と根室振興局管内の6村を status で区別)
...
LETTER = {'S': '宗谷', 'R': '留萌', 'K': '上川', 'O': 'オホーツク', 'Z': '空知', 'I': '石狩',
          ...
          'N': '根室', 'W': '渡島', 'E': '檜山',
          'X': '北方領土'}   # 北方領土の6村 (根室振興局管内。179市町村だけの表示では余白として描く)
...
# (15,3) (15,6) は海峡にあたる余白。179市町村だけの表示でこの列全体が海として読めるように、6村は x=15 だけに置く。
